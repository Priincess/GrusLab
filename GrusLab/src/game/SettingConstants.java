...
public interface SettingConstants {
    ...
    String MINION_WIDTH = "MINION_WIDTH";
    String MINION_WIDTH_DEFAULT = "175";
    String MINION_HEIGHT = "MINION_HEIGHT";
    String MINION_HEIGHT_DEFAULT = "175";
    String MINION_OFFSET = "MINION_OFFSET";
    ...
    String GOGGLE_SPEED_TIME = "GOGGLE_SPEED_TIME";
    String GOGGLE_SPEED_TIME_DEFAULT = "10";
