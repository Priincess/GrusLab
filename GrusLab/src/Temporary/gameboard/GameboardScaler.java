...
public class GameboardScaler {
    ...
    private void loadScalerPreferences(){
        _camLT = new Point(_scalerPreferences.getInt("CAMLT_X", -1), _scalerPreferences.getInt("CAMLT_Y", -1));
        _camRT = new Point(_scalerPreferences.getInt("CAMRT_X", -1), _scalerPreferences.getInt("CAMRT_Y", -1));
        _camRB = new Point(_scalerPreferences.getInt("CAMRB_X", -1), _scalerPreferences.getInt("CAMRB_Y", -1));
        _camLB = new Point(_scalerPreferences.getInt("CAMLB_X", -1), _scalerPreferences.getInt("CAMLB_Y", -1));

        _gameLT = new Point(_scalerPreferences.getInt("GAMELT_X", -1), _scalerPreferences.getInt("GAMELT_Y", -1));
        _gameRT = new Point(_scalerPreferences.getInt("GAMERT_X", -1), _scalerPreferences.getInt("GAMERT_Y", -1));
        _gameRB = new Point(_scalerPreferences.getInt("GAMERB_X", -1), _scalerPreferences.getInt("GAMERB_Y", -1));
        _gameLB = new Point(_scalerPreferences.getInt("GAMELB_X", -1), _scalerPreferences.getInt("GAMELB_Y", -1));
    }
    ...
    public void setCameraPoints(Point camLT, Point camRT, Point camRB, Point camLB){
        _camLT = camLT;
        _camRT = camRT;
        _camRB = camRB;
        _camLB = camLB;
    ...
    public void setGamePoints(Temporary.gameboard.Point gameLT, Temporary.gameboard.Point gameRT, Temporary.gameboard.Point gameRB, Temporary.gameboard.Point gameLB){
        _gameLT = new Point(gameLT.getX(), gameLT.getY());
        _gameRT = new Point(gameRT.getX(), gameRT.getY());
        _gameRB = new Point(gameRB.getX(), gameRB.getY());
        _gameLB = new Point(gameLB.getX(), gameLB.getY());
    }
    ...
    public Temporary.gameboard.Point transformCameraPointToGameboardPoint(Point cameraPoint){
        ...
        Temporary.gameboard.Point point = new Temporary.gameboard.Point((int)points[0], (int)points[1]);
        return point;
    }
}
